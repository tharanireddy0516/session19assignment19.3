...
public class EmployeeDetail {//created class name as EmployeeDetail
    ...
    public static void main(String[] args) {//Here public is a access modifier which defines who can access this method
        ...
        Employee empOne = new Employee("Varshini", "Manager", 90000);//taking employee deatils
        Employee emplTwo = new Employee("Meena", "Ass.Manager", 75000);
        Employee emplThree = new Employee("Harini", "Area Dept. Manager", 45000);
        Employee emplFour = new Employee("Tharani", "Area Dept. Manager", 45000);
        Employee emplFive = new Employee("Thanmayi", "salesmen", 25000);
